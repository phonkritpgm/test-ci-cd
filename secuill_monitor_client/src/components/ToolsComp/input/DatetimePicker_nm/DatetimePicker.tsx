...
const DatetimePickerNM = () => {
    ...
    useEffect(() => {
        ...
        const createButton = (text: any, isDisabled = false, type = 0) => {
            ...
            const comparisonDate: any = new Date(year, month + type, text);
    ...
    return (
        <React.Fragment>
            <div className="datepicker-container">
                <input type="text" readOnly className="date-input" placeholder="Select date" />
...
export default DatetimePickerNM;