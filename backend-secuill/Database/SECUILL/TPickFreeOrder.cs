...
[PrimaryKey("PickorderNo", "PickorderSeq", "OrderNo")]
[Table("T_PickFreeOrder")]
public partial class TPickFreeOrder
{
    [Key]
    [Column("pickorder_no")]
    [StringLength(20)]
    ...
    [Key]
    [Column("pickorder_seq", TypeName = "numeric(3, 0)")]
    public decimal PickorderSeq { get; set; }
    ...
    [Column("pickorder_qty", TypeName = "decimal(4, 2)")]
